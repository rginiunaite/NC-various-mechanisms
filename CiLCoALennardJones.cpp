...
VectorXi proportions(int n_seed) {
    ...
    double sigma_max = 7.5;//15.0; // maximum distance at which the cells can have an effect on each other
    double search_param = 50; //radius to search for cell-cell interactions
    double f0 = 1.0;// strength of the force
    double eps_ij = 1.0; // depth of potential well
